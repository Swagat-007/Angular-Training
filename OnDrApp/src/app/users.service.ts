...
import { DoctorProfileForm , EmployeeForm, PatientForm} from './model/model';
...
export class UsersService {
  ...
  Saveuser(save: any){
    console.log(save);
    return this.http.post<any>(this.url+"/getAlldata",save);
  }

  Savedoctor(savedr : any){
    console.log(savedr);
    return this.http.post<any>(this.url+"/Doctordata",savedr)
  }
